...
^^^^^^^
    ...
    * :py:mod:`mozaik.models.__init__` - This module defines the base Model class that defines the structure, parameters, and control logic for Mozaik neural network simulations.
