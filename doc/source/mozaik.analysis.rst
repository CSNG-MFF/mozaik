...
^^^^^^^    
    ...
    * :py:mod:`mozaik.analysis.analysis_data_structures` - contains definitions of data stractures that the analysis algorithms produce
    * :py:mod:`mozaik.analysis.analysis_helper_functions` - some utility functions that are used in the analysis package 
...
:mod:`mozaik.storage.datastore`, in the form of recorded data or analysis data structures (see :mod:`mozaik.analysis.analysis_data_structures`)
...
responsible for packaging its results into one or a set of the data structures defined in :mod:`mozaik.analysis.analysis_data_structures` and send them to the 
...
The five parameters that are common to each ADS and are defined in the top :class:`mozaik.analysis.analysis_data_structures.AnalysisDataStructure` class are:
...
For more details see the :mod:`mozaik.analysis.analysis_data_structures` and :mod:`mozaik.analysis.analysis` module and specifically the two most 
important API classes: :class:`mozaik.analysis.analysis_data_structures.AnalysisDataStructure` and :class:`mozaik.analysis.analysis.Analysis`
