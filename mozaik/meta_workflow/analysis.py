...
def run_analysis_on_parameter_search(
    simulation_name, master_results_dir, analysis_function
):
    """
    ...
    """
    (a, datastores, n) = load_fixed_parameter_set_parameter_search(
...
def collect_results_from_parameter_search(
    simulation_name, master_results_dir, processing_function, file_name
):
    """
    ...
    for v in value_names:
        ...
        for (pv, datastore) in datastores:
            ...
            if (
                ...
                vv = (
                    param_filter_query(dsv, identifier="SingleValue", value_name=v)
