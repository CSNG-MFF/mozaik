...
class MozaikParametrized(Parameterized):
    ...
    name = String(default=None, constant=True, precedence=-1,
                  doc="String identifier for this object.")
...
class SNumber(Number):
    ...
    def __init__(self, units, period=None, **params):
        super(SNumber, self).__init__(default=None, allow_None=True,
...
class SInteger(Integer):
    ...
    def __init__(self, period=None, **params):
        super(SInteger, self).__init__(default=None, allow_None=True,
                                       instantiate=True, **params)
        self.units = None
        self.period = period
...
class SString(String):
    ...
    def __init__(self, **params):
        super(SString, self).__init__(default=None, allow_None=True,
                                      instantiate=True, **params)
        self.units = None
        self.period = None
