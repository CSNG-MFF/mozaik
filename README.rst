...
Now you can install all other dependencies in this protected environment::
  ...
  pip3 install "numpy<2" scipy mpi4py matplotlib quantities lazyarray interval Pillow param==1.5.1 parameters neo cython==3.0.10 psutil future requests PyYAML elephant pytest-xdist pytest-timeout junitparser numba numpyencoder sphinx imageio pandas scikit-image som-pbc setuptools==80.9.0
