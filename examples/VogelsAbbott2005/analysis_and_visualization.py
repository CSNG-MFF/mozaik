...
def perform_analysis_and_visualization(data_store):
    ...
    if True: # PLOTTING
            ...
            PSTH(param_filter_query(data_store,st_direct_stimulation_name="None"),ParameterSet({'bin_length' : 5.0, 'analyze_blank_stimuli': False})).analyse()
            ...
            PopulationMeanAndVar(data_store,ParameterSet({'ignore_nan_and_inf': False})).analyse()
