...
def perform_analysis_and_visualization(data_store):
    if True:
        ...
        l4_exc = analog_ids[
            numpy.argmin(
                [
                    ...
                    for (o, p) in zip(
                        l4_exc_or[0].get_value_by_id(analog_ids),
        ...
        l4_inh = analog_ids_inh[
            numpy.argmin(
                [
                    circular_dist(o, numpy.pi / 2, numpy.pi)
                    for (o, p) in zip(
                        l4_inh_or[0].get_value_by_id(analog_ids_inh),
        ...
        RetinalInputMovie(
            dsv,
            ParameterSet({}),
            fig_param={"dpi": 100, "figsize": (28, 12)},
            plot_file_name="video",
        ).plot()
