...
import matplotlib
matplotlib.use('MacOSX') # do this before importing pylab
...
if False:
    ...
    experiment_list =   [
                           ...
                           #MeasureOrientationTuningFullfield(jens_model,num_orientations=1,spatial_frequency=0.8,temporal_frequency=2,grating_duration=57*7,num_trials=5),
